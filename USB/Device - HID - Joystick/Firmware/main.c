...
//	to it in HardwareProfile.h.
    ...
    tris_self_power = INPUT_PIN;	// See HardwareProfile.h
	 ...
	 ANSELH = 0x00; ANSEL = 0x00; 	/*
				 	 				page 98,99 pic18f14k50 data sheet
									*/
...
void Joystick(void)
{
    ...
    if(!HIDTxHandleBusy(lastTransmission))
    {
        ...
        if(!sw1 || !sw2  || !sw7  || !sw8 || !sw9 || !sw10 || !sw4 || !sw5 || !sw3 || !sw6)
        {
        //Indicate that the "x" button is pressed, but none others
	        if(!sw1)
	        {
	            joystick_input.members.buttons.square = 1;  //#1
	        }
	        else
	        {
	        ...
	        if(!sw2)
	        {
	            joystick_input.members.buttons.x = 1; //#2
	        }
	        else
	        {
	        ...
	        if(!sw7) //switch is suspected short
	        {
	            joystick_input.members.buttons.o = 1; //#3 
	        }
	        else
	        {
	        ...
	        if(!sw8) //switch is suspected short
	        {
	            joystick_input.members.buttons.triangle = 1; //#4
	        }
	        else
	        {
	        ...
	        if(!sw9) //switch is suspected short
	        {
	            joystick_input.members.buttons.L1 = 1; //#5
	        }
	        else
	        {
	        ...
	        if(!sw10)
	        {
	            joystick_input.members.buttons.R1 = 1; //#6
	        }
	        else
	        {
	        ...
	        if(!sw4)
	        {
	            joystick_input.members.buttons.L2 = 1; //# 7 
            	joystick_input.members.hat_switch.hat_switch = HAT_SWITCH_NORTH;
	        }
	        else
	        {
	        ...
	        if(!sw5)  //short
	        {
	            joystick_input.members.buttons.R2 = 1; //#8  
				joystick_input.members.hat_switch.hat_switch = HAT_SWITCH_SOUTH;
	        }
	        else
	        {
				joystick_input.members.buttons.R2 = 0; 
			}
	        if(!sw3) //switch is suspected short
	        {
	        ...
	        if(!sw6) //short
	        {
				...
				joystick_input.members.hat_switch.hat_switch = HAT_SWITCH_WEST;
            ...
            joystick_input.members.buttons.select = 0; //#9
            joystick_input.members.buttons.start = 0; //#10
