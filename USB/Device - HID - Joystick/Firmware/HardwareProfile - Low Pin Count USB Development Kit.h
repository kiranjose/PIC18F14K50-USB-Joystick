...
#define HARDWARE_PROFILE_LOW_PIN_COUNT_USB_DEVELOPMENT_KIT_H
	...
	#define sw2                 PORTBbits.RB6
		#define sw7                 PORTCbits.RC1
		#define sw8                 PORTCbits.RC0
		#define sw9                 PORTCbits.RC6
    #define sw10                PORTCbits.RC5

	//direction buttons
    #define sw4                PORTCbits.RC4 //up
    	#define sw5                PORTCbits.RC3 //down
    	#define sw3                PORTCbits.RC7 //right
    	#define sw6                PORTCbits.RC2 //left
	
    #define mInitPOTY()          {TRISBbits.TRISB4=1;ADCON0=0x29;ADCON1=0;ADCON2=0x3E;ADCON2bits.ADFM = 1;}
    #define mInitPOT()          {TRISBbits.TRISB5=1;ADCON0=0x2D;ADCON1=0;ADCON2=0x3E;ADCON2bits.ADFM = 1;} 
